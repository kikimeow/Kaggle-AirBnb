...
train$first_browser[train$first_browser %in% c("Opera","Opera Mini","Opera Mobile")] <- "Firefox"
test$first_browser[test$first_browser %in% c("Opera","Opera Mini","Opera Mobile")] <- "Firefox"
